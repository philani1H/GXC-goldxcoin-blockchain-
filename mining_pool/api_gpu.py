#!/usr/bin/env python3
"""
Vercel serverless function wrapper for GPU mining pool
"""
import sys
import os
...
if 'DATABASE_PATH' not in os.environ:
    os.environ['DATABASE_PATH'] = '/tmp/gpu_pool.db'
...
try:
    ...
    @app.route('/')
    def error():
        return f"GPU Pool initialization error: {str(e)}", 500
    
    @app.route('/api/stats')
    def api_stats():
        return {'error': 'GPU Pool not initialized', 'details': str(e)}, 500
