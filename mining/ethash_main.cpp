...
void printBanner() {
 ...
 | (__  | .` || (__    | _| |  _|| ' \ / _` |(_-< | ' \
  \___| |_|\_| \___|   |___| \__||_||_|\__,_|/__/ |_||_| 
                                                         
GXC Ethash Miner - Ethereum-Compatible Algorithm
Version 1.0.0
    )" << std::endl;
}

void printHelp() {
    std::cout << "GXC Ethash Miner - Usage:" << std::endl;
    std::cout << "  gxc-ethash-miner [options]" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  * Ethash algorithm (Ethereum-compatible)" << std::endl;
    std::cout << "  * DAG generation and caching" << std::endl;
    std::cout << "  * GPU mining support" << std::endl;
    std::cout << "  * Full traceability support" << std::endl;
    std::cout << std::endl;
    std::cout << "Examples:" << std::endl;
    std::cout << "  gxc-ethash-miner -a gxc1abcd..." << std::endl;
    std::cout << "  gxc-ethash-miner -a gxc1abcd... --pool=stratum+tcp://pool.gxc.io:4444 --username=miner1" << std::endl;
    std::cout << std::endl;
}
...
void printMiningInfo(const MinerConfig& config) {
    ...
    std::cout << "Algorithm: Ethash (Ethereum-compatible)" << std::endl;
...
int main(int argc, char* argv[]) {
    ...
    LOG_MINING(LogLevel::INFO, "Starting GXC Ethash Miner");
    ...
    try {
        ...
        g_miningManager->setMiningAlgorithm(MiningAlgorithm::ETHASH);
    ...
    LOG_MINING(LogLevel::INFO, "GXC Ethash Miner shutdown complete");
